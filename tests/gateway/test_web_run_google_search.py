"""Tests for the self-hosted Google executor packaged in ``web-run``."""
...
from codex_rosetta.gateway.resources.web_run.google_search import (
    build_google_search_url,
    execute_google_search,
)


def test_google_search_url_applies_site_filters_without_changing_input() -> None:
...
def test_google_search_url_rejects_non_domain_filters(domain: str) -> None:
...
def test_google_search_normalizes_results_and_closes_context() -> None:
