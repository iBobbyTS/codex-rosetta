...
actual upstream is the selected multimodal model (`qwen3.7-plus` by default). The exact success marker must identify red
...
```json
{
  ...
  "model_shape_reference": "gpt-5.6-terra",
