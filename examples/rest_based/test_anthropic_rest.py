#!/usr/bin/env python
"""
REST API test for Anthropic Messages API
...
def get_current_weather(location: str, unit: str = "celsius") -> str:
    ...
    return json.dumps({"location": location, "temperature": "18", "unit": unit})


def main():
    print("=" * 80)
    print("Anthropic Messages API REST Test")
    print("=" * 80)
    ...
    ir_messages = [
        {
            "role": "user",
            "content": [
                {"type": "text", "text": "What's the weather like in New York?"}
            ],
        }
    ]
    ...
    print("\n--- Converting IR to Anthropic format ---")
