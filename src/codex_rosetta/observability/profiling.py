...
class ProfilerState:
    ...
    :class:`~codex_rosetta.profiling.DeepProfiler` instance to avoid
    ...
    def create_profiler(self) -> Any:
        ...
        Returns:
            A :class:`~codex_rosetta.profiling.DeepProfiler` instance.

        Raises:
            RuntimeError: If pyinstrument is not installed.
        """
        from codex_rosetta.profiling import DeepProfiler
