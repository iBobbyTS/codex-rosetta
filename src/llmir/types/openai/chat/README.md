...
This directory contains TypedDict replicas of OpenAI Chat Completion API types, providing type-safe interfaces for the LLMIR library's OpenAI Chat converter.
...
- Allows LLMIR to work without requiring the full OpenAI SDK installation
...
This section shows how LLMIR's IR types map to OpenAI Chat types for conversion:
...
diff -r /path/to/openai/types/chat/ ./src/llmir/types/openai/chat/
```
...
def test_openai_type_compatibility():
    ...
    llmir_response: LLMIRChatCompletion = sdk_response.model_dump()
```
...
```python
from llmir.types.openai.chat import ChatCompletion
...
- [LLMIR IR Types](../ir/)
- [LLMIR OpenAI Chat Converter](../../converters/openai/chat/)
