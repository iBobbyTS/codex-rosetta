...
<Modal open={modalOpen} className="provider-modal" labelledby="provider-modal-title" onclose={closeProviderModal}>
  ...
  {#if editingName}
    <div class="form-group provider-binding">
      ...
      <Dropdown id="providerBinding" value={boundAccountId} options={bindingOptions()} fitViewport={true} onChange={(value:DropdownValue)=>selectBinding(String(value))} />
