...
| Routing, Provider identity, and HTTP/SSE transport | `src/codex_rosetta/routing.py`, `src/codex_rosetta/gateway/app.py`, `config.py`, `logging.py`, `proxy.py`, `stream_trace.py`, `providers.py`, `transport/provider_info.py`, `transport/credential_redaction.py`, `transport/credential_semantics.py`, `transport/http/`, `transport/sse_format.py`, `src/codex_rosetta/observability/redaction.py`, `metrics.py`, `persistence.py` | `tests/gateway/test_downstream_routes.py`, `test_responses_passthrough.py`, `test_http_transport_limits.py`, `test_provider_return_redaction.py`, `test_transport_credential_redaction.py`, `test_stream_trace.py`, `test_stream_telemetry_lifecycle.py`, `test_providers.py`, `test_admin_config_routes.py`, `tests/observability/test_redaction.py`, `test_metrics.py`, `test_persistence_sqlite.py`, `tests/integration/gpt_relay/`, current `docs/audit/FINDINGS.md` and `COVERAGE.md` | `CP-01`, `CP-02`, `CP-03`, `CP-17`, `CP-21`, `CP-22`, `AUD-022`, `AUD-023`, `AUD-025` |
...
| Response/stream lifecycle, phase, and trace evidence | `src/codex_rosetta/gateway/app.py`, `proxy.py`, `stream_phase_buffer.py`, `stream_trace.py`, `logging.py`, `transport/credential_redaction.py`, `transport/credential_semantics.py`, `transport/http/`, `src/codex_rosetta/observability/metrics.py`, `persistence.py`, response and stream converters under `src/codex_rosetta/converters/` | `tests/gateway/test_stream_phase_buffer.py`, `test_stream_trace.py`, `test_body_logging.py`, `test_stream_telemetry_lifecycle.py`, `test_chat_stream_eof_finalize.py`, `test_provider_return_redaction.py`, `test_transport_credential_redaction.py`, `tests/observability/test_metrics.py`, `test_persistence_sqlite.py`, converter response/stream tests | `CP-02`, `CP-17`, `CP-18`, `CP-19`, `AUD-025` |
