...
| Direct Responses and compaction | `src/codex_rosetta/gateway/codex_compaction.py`, `codex_compact_prompt.md`, `codex_compact_summary_prefix.md`, `proxy.py`, `tool_profiles.py` | `tests/gateway/test_codex_compaction.py`, `test_responses_passthrough.py`, `test_tool_profiles.py`, `tests/live_agent/context_compaction/`, `tests/live_agent/context_compaction_summary_quality/` | `CP-02`, `CP-04`, `CP-10`, `CP-20`, `CP-21` |
