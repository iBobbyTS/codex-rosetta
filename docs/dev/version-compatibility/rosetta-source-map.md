...
| Responses bridge and public wire types | `src/codex_rosetta/converters/openai_responses/`, especially `content_ops.py` and `message_ops.py` for Codex `input_audio`, `src/codex_rosetta/types/openai/responses/`, `src/codex_rosetta/types/ir/parts.py`, target converter `tool_ops.py`, `src/codex_rosetta/pipeline.py`, `src/codex_rosetta/gateway/proxy.py` | `tests/converters/openai_responses/`, `tests/converters/base/test_tool_content.py`, `tests/converters/test_computer_tool_contract.py`, `tests/test_types/openai_responses/`, `tests/test_pipeline.py`, `docs/audit/runs/20260721-1148/` | `CP-05`, `CP-06`, `CP-08`, `CP-11`, `CP-17`, `CP-18`, `CP-19`, `CP-20`, `AUD-024` |
