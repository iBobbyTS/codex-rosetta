...
| Routing, Provider identity, and HTTP/SSE transport | `src/codex_rosetta/routing.py`, `src/codex_rosetta/gateway/app.py`, `config.py`, `headers.py`, `model_protocol_credentials.py`, `logging.py`, `proxy.py`, `stream_trace.py`, `providers.py`, `transport/provider_info.py`, `transport/http/`, `transport/sse_format.py`, `src/codex_rosetta/observability/redaction.py`, `error_dump.py`, `persistence.py` | `tests/gateway/test_downstream_routes.py`, `test_app_headers.py`, `test_responses_passthrough.py`, `test_http_transport_limits.py`, `test_provider_return_redaction.py`, `test_stream_trace.py`, `test_body_logging.py`, `test_upstream_error_logging.py`, `tests/observability/test_error_dump.py`, `tests/integration/gpt_relay/`, current audit ledgers | `CP-01`, `CP-02`, `CP-17`, `CP-21` |
...
| Model capability enforcement | `src/codex_rosetta/capabilities.py`, `src/codex_rosetta/pipeline.py`, `src/codex_rosetta/shims/provider_shim.py`, `src/codex_rosetta/gateway/model_presets.py`, `config.py`, `proxy.py`, `tool_profiles.py`, `code_mode_projection.py`, reasoning transforms under `src/codex_rosetta/shims/providers/`, `src/codex_rosetta/converters/base/helpers/image_limit.py` | `tests/test_pipeline.py`, `tests/test_shims.py`, `tests/test_provider_reasoning_transforms.py`, `tests/gateway/test_model_presets.py`, `test_config.py`, `test_tool_profiles.py`, `test_code_mode_projection.py` | `CP-01`, `CP-07`, `CP-09`, `CP-19`, `CP-22` |
| Chat bridge and reasoning mapping | `src/codex_rosetta/converters/openai_chat/`, especially `content_ops.py` and `message_ops.py` for Chat `input_audio`, `src/codex_rosetta/converters/base/helpers/reasoning.py`, `src/codex_rosetta/reasoning_mapping.py`, `src/codex_rosetta/pipeline.py`, provider reasoning transforms under `src/codex_rosetta/shims/providers/` | `tests/converters/openai_chat/`, `tests/converters/base/test_tool_content.py`, `tests/converters/test_reasoning_helpers.py`, `tests/test_reasoning_mapping.py`, `tests/test_provider_reasoning_transforms.py`, `tests/test_pipeline.py` | `CP-05`, `CP-08`, `CP-12`, `CP-17`, `CP-19`, `CP-20` |
